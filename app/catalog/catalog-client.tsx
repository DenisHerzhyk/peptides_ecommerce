  ...
  return (
    <>
      <section className="relative overflow-hidden">
        <div
          className="absolute inset-0 holo-gradient-animated opacity-50"
          aria-hidden
        />
        <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
          ...
          <p className="mt-3 max-w-xl text-muted-foreground">
            Lab-verified research peptides and bundles. All products supplied
      ...
      <section
        id="bundles"
        className="mx-auto max-w-7xl scroll-mt-20 px-4 py-12 sm:px-6 lg:px-8 lg:py-20"
      >
